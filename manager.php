...
if(!isset($_SESSION['uname_manager'])){
...
<html>
    ...
    <header>
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item text-white">
                            <div class="nav-link">
                            Logged in as: <?php echo $_SESSION['uname_manager'];?>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container-manager-files">
            <form action="file.php" method="post">  <!-- List files inside drop-down list -->
                <?php
                $str = 'uploads/SelectedSubmissions/*';
                $fileList = glob($str);
                $replaceStr = 'uploads/SelectedSubmissions/';
                echo "<h5>Selected Submissions</h5>";
