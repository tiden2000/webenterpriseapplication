...
if(!isset($_SESSION['uname']) or !isset($_SESSION['IT'])){
    session_destroy();
...
<html>
    <head>
        ...
        <title>Information Technology Faculty</title>
    </head>
    <body>
    <header>
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <div class="container-closuredate">
                ...
                $sql = "select closuredate from deadlines where id=1";
                ...
                $sql = "select closuredatefinal from deadlines where id=1";
        ...
        <input type="hidden" id="faculty_input" name="faculty" value="IT" /> <!-- This hidden input lets the fileUploadScript.php know the correct faculty folder to upload to -->
        ...
        <input type="file" name="the_file" id="fileToUpload">
        <input type="hidden" id="faculty_input" name="faculty" value="IT" /> <!-- This hidden input lets the fileUpdateScript.php know the correct faculty folder to upload to -->
        ...
        $path = "uploads/Information Technology/" . $id;
        if (!file_exists($path)) {
        ...
        <?php
        $str = 'uploads/Information Technology/' . $id . '/*';
        $fileList = glob($str);
        $replaceStr = 'uploads/Information Technology/' . $id . '/';
        ...
        echo "</select>";
        ?>
        <input type="hidden" id="faculty_input" name="faculty" value="IT"/>
