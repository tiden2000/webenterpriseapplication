...
if(!isset($_SESSION['uname']) or !isset($_SESSION['PO'])){
    session_destroy();
...
<html>
    ...
    <header>
        ...
        <div class="container-closuredate">
                ...
                $sql = "select closuredate from deadlines where id=3";
                ...
                $sql = "select closuredatefinal from deadlines where id=3";
        ...
        <input type="hidden" id="faculty_input" name="faculty" value="PO" />  <!-- This hidden input lets the fileUploadScript.php know the correct faculty folder to upload to -->
        ...
        <input type="file" name="the_file" id="fileToUpload">
        <input type="hidden" id="faculty_input" name="faculty" value="PO" /> <!-- This hidden input lets the fileUpdateScript.php know the correct faculty folder to upload to -->
        ...
        <?php
        $str = 'uploads/Politics/' . $id . '/*';
        $fileList = glob($str);
        $replaceStr = 'uploads/Politics/' . $id . '/';
        ...
        echo "</select>";
        ?>
        <input type="hidden" id="faculty_input" name="faculty" value="PO"/>
